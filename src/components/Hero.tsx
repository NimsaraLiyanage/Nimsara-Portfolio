        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <div className="relative w-96 h-96 mx-auto rounded-full p-1 bg-gradient-to-r from-orange-400 via-red-500 to-purple-500 hover:scale-105 transition-transform duration-300 shadow-[0_4px_30px_rgba(255,255,255,0.5)] flex items-center justify-center">
              ...
              src={Profile}
              alt="Profile"
              className="rounded-full w-80 h-80 object-cover hover:shadow-[0_0_20px_5px_rgba(255,255,255,0.7)] transition-shadow duration-300 items-center justify-center"
              />
            </div>
          </motion.div>
        </div>
